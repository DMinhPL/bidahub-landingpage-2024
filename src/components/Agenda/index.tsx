...
const Agenda: React.FC<{
    ...
    lang = ''
        ...
        const items: AgendaItems[] = useMemo(() => [
            ...
            { date: '05/12/2024', description: lang === 'en' ? 'Close Registration. (May close early if athlete limit is reached)' : 'Đóng cổng đăng kí tham gia thi đấu. (Thời gian có thể kết thúc sớm hơn nếu đã đủ số lượng VDV)' },
            {
                date: '09/12/2024',
                description: lang === 'en' ? 'Referee Team Conducts Draw and Divides Competition Groups' : 'Tổ trọng tài bốc thăm và chia nhóm thi đấu',
            },
            {
                date: '11/12/2024 - 16/12/2024',
            ...
            {
                date: '17/12/2024',
                description: lang === 'en' ? 'Semifinal , Finals and Prize Ceremony' : 'Bán kết, Chung kết và trao giải ',
